...
const API_BASE_URL =
  process.env.EXPO_PUBLIC_API_URL ?? 'https://church-connect-api-qylf.onrender.com/api/v1';
...
export default function RegisterScreen({ navigation }: Props) {
  ...
  // ── Deep link listener (same as LoginScreen) ───────────────────────────────
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        <TouchableOpacity
          style={[
            styles.googleBtn,
            { backgroundColor: isDark ? '#1F2937' : 'white', borderColor: isDark ? '#374151' : '#D1D5DB' },
        ...
        <Text variant="bodySmall" style={[styles.passwordHint, { color: c.textSecondary }]}>
        ...
        <View style={styles.loginRow}>
          ...
          <TouchableOpacity onPress={goToLogin}>
            <Text variant="bodyMedium" style={styles.loginLink}>Sign in</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  passwordHint: { marginBottom: 20, marginTop: -8 },
  button: { marginTop: 4 },
