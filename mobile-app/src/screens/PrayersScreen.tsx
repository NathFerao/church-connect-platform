...
const CATEGORY_OPTIONS = [
  ...
  { value: 'THANKSGIVING', label: 'Thanks' },
...
export default function PrayersScreen() {
  ...
  const openModal = () => {
    setTitle(''); setDescription(''); setCategory('OTHER'); setIsAnonymous(false);
  ...
  return (
    <View style={[styles.container, { backgroundColor: c.background }]}>
      <FlatList
          ...
          return (
            <Card style={[styles.card, { backgroundColor: c.surface }]}>
              <Card.Content>
                ...
                <Text variant="bodyMedium" style={[styles.description, { color: c.textSecondary }]}>
                  {item.description}
                </Text>
        ...
        ListEmptyComponent={
          <Text style={[styles.empty, { color: c.textSecondary }]}>No prayer requests yet</Text>
        }
      />
