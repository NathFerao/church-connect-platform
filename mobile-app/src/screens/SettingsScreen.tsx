    ...
    >
      ...
      <View style={[styles.tabs, { backgroundColor: isDark ? '#374151' : '#F3F4F6' }]}>
        {([
          ...
          >
            <Text style={[
              styles.tabText,
              { color: activeSection === tab.key ? colors.primary : c.textSecondary },
      ...
      {activeSection === 'password' && (
        <Surface style={[styles.section, { backgroundColor: c.surface }]} elevation={1}>
          ...
          <TextInput label="Current Password" value={currentPassword}
            onChangeText={setCurrentPassword} secureTextEntry={!showCurrent}
            right={<TextInput.Icon icon={showCurrent ? 'eye-off' : 'eye'}
              onPress={() => setShowCurrent((v) => !v)} />}
            style={styles.input} mode="outlined" />

          <TextInput label="New Password" value={newPassword}
            onChangeText={setNewPassword} secureTextEntry={!showNew}
            right={<TextInput.Icon icon={showNew ? 'eye-off' : 'eye'}
          ...
          <TextInput label="Confirm New Password" value={confirmPassword}
            ...
            right={<TextInput.Icon icon={showConfirm ? 'eye-off' : 'eye'}
